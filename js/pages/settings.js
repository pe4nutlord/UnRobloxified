...
let categories = [
    {
        ...
        content: [
            ...
            },
            {
                ...
                text: `Having multiple extensions enabled can cause problems with Robloxify, make sure that you have properly configured all of your settings in all of your extensions so that it doesn't cause any problems with Robloxify.`
            }
        ]
    },
    {
        ...
        content: [
            ...
            //     options: [
            //         {
            //             header: "Robloxify Update Notifications",
            //             text: "Get notified when Robloxify has a new major update, allowing you to explore new settings and features when they're available.",

            //             toggleable: true,
            //             disabled: true,
            //             setting: "general.robloxifyUpdates"
            //         }
            //     ]
            // },
            {
        ...
        content: [
            ...
            // },
            {
                ...
                options: [
                    {
                        header: "Recent Items",
                        text: "This adds a new category that lets you quickly see the most recent items on the catalog made by Roblox.",
...
pages.settings = () => {
    ...
    function loadCategory(name) {
        if (!settingsCooldown && name != selectedCategory) {
            ...
            $(".robloxify-settings-content").empty();

            category.content.forEach((categroyContent) => {
                let section = $(`<div class="section"></div>`).appendTo(".robloxify-settings-content");
